                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.html">Where2Get</a>
                            ...
                            <div class="col-md-10">
                                <form class="form-wrap mt-4">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <input type="text" placeholder="Abuja" class="btn-group2">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="add-listing-wrap">
                        <h2>Have a business in Abuja?</h2>
                        <p>Put your business where customers can find you...</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="/addproduct" class="btn btn-danger"><span class="ti-plus"></span> ADD PRODUCT/SERVICE</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        ...
                        <p>Copyright &copy; 2018 Where2Get. All rights reserved <!-- | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> --></p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        <ul>
