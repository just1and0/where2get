                         ...
                         <div class="row">
                                <div style="background-color:white;height:100vh;" class="col-lg-6 flex items-center justify-center">
                                            <div class="text-black text-5xl md:text-15xl font-black">
                                                <span class="size">Donate</span>
                                               
                                                 <div class="w-16 h-1 bg-purple-light my-3 md:my-6"></div>
                                                 <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal">
                                                   Has where2get been of any help to you over the years?             </p>
                                                <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal">
                                                    do good to donate to support us and keep us going .
                                                </p>
                                               
                                                <form>
    <script src="https://api.ravepay.co/flwv3-pug/getpaidx/api/quidpay-inline.js"></script>
    <button class="btn btn-lg btn-success" type="button" onClick="payWithQuidpay()">Pay Now</button>
</form>
        ...
        var x = getpaidSetup({
            ...
            callback: function(response) {
                ...
                x.close(); // use this to close the modal immediately after payment.
                                            ...
                                            <button class="btn-lg btn-primary btn">back to home</button>
                                            </a>
